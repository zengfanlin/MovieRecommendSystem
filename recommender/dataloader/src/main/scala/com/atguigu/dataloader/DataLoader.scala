...
object DataLoader {
  val MOVIE_DATA_PATH = "D:\\00-workspace\\01_java\\MovieRecommendSystem\\recommender\\dataloader\\src\\main\\resources\\movies.csv"
  val RATING_DATA_PATH = "D:\\00-workspace\\01_java\\MovieRecommendSystem\\recommender\\dataloader\\src\\main\\resources\\ratings.csv"
  val TAG_DATA_PATH = "D:\\00-workspace\\01_java\\MovieRecommendSystem\\recommender\\dataloader\\src\\main\\resources\\tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    var newTag = tagDF.groupBy($"mid").agg(concat_ws("|", collect_set($"tag")).as("tags")).select("mid", "tags")
  ...
  def storeDataInMongoDB(movieDF: DataFrame, ratingDF: DataFrame, tagDF: DataFrame)(implicit mongoConfig: MongoConfig): Unit = {
    ...
    movieDF
      ...
      .option("collection", MONGODB_MOVIE_COLLECTION) //数据集
      .mode("overwrite")
